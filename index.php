    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="list-group">
                ...
                <a href="salir.php" onclick="cambiarurl('course/curso_php.html','response')" class="d-flex align-items-center btn btn-rosa rounded-0 border-3 border-light text-start mb-1 text-light"> Salir</a>
            </div>
        </div>
